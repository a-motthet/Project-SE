  ...
  if (!pet) {
    return (
      <div className="min-h-screen flex items-center justify-center font-sans">
        <p className="text-red-500 text-xl">ไม่พบข้อมูลสัตว์เลี้ยงที่คุณต้องการ</p>
      </div>
    );
  }
  return (
    <div className="min-h-screen flex items-center justify-center font-sans">
      <div className="bg-white rounded-large shadow-inner w-11/12 lg:w-3/4 xl:w-2/3">
        <p className="pl-8 pt-8 text-puple-b text-3xl font-bold">{pet.name}</p>
        <div className="grid grid-cols-4 items-center">
          <div className="col-span-3">
            <div className="grid grid-cols-2 mb-2">
              ...
              <div className="text-puple-b text-xl">เพศของสัตว์: {pet.sex}</div>
            </div>
            <div className="grid grid-cols-2 mb-2">
              <div className="ml-8 text-puple-b text-xl">
